...
namespace Microsoft.AspNet.SignalR.Tests
{
    public class DefaultActionResolverFacts
    {
        ...
        public void ResolveActionBindsComplexArguments()
        {
            ...
            MethodDescriptor actionInfo;
            resolver.TryGetMethod(new HubDescriptor { HubType = typeof(TestHub), Name = "TestHub" }, "MethodWithComplex", out actionInfo, new object[] { new JTokenValue(arg) });
        ...
        public void ResolveActionBindsSimpleArrayArgument()
        {
            ...
            MethodDescriptor actionInfo;
            resolver.TryGetMethod(new HubDescriptor { HubType = typeof(TestHub), Name = "TestHub" }, "MethodWithArray", out actionInfo, new object[] { new JTokenValue(arg) });
        ...
        public void ResolveActionBindsComplexArrayArgument()
        {
            ...
            MethodDescriptor actionInfo;
            resolver.TryGetMethod(new HubDescriptor { HubType = typeof(TestHub), Name = "TestHub" }, "MethodWithArrayOfComplete", out actionInfo, new object[] { new JTokenValue(new JArray(new object[] { arg })) });
        ...
        private class JTokenValue : object
        {
